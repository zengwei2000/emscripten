...
def install_system_headers(stamp):
  ...
  #define EMSCRIPTEN_VERSION_MAJOR {shared.EMSCRIPTEN_VERSION_MAJOR}
  #define EMSCRIPTEN_VERSION_MINOR {shared.EMSCRIPTEN_VERSION_MINOR}
  #define EMSCRIPTEN_VERSION_PATCH {shared.EMSCRIPTEN_VERSION_PATCH}

  // Legacy names with mixed case, and surrounded by __
  #define __EMSCRIPTEN_major__ EMSCRIPTEN_VERSION_MAJOR
  #define __EMSCRIPTEN_minor__ EMSCRIPTEN_VERSION_MINOR
  #define __EMSCRIPTEN_tiny__ EMSCRIPTEN_VERSION_PATCH
  '''))
